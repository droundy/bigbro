// This file is based on code from the rust standard library.
//
// Copyright 2017 David Roundy <daveroundy@gmail.com>
//
// Copyright 2016 The Rust Project Developers. For details see
...
impl Stdio {
    pub fn to_child_stdio(&self, readable: bool)
        ...
        match *self {
            ...
            Stdio::Fd(ref fd) => {
                Ok((ChildStdio::Explicit(*fd), None))
            }
            ...
            Stdio::Null => {
                ...
                // Ok((ChildStdio::Owned(fd.into_raw_fd()), None))
                unimplemented!()
            }
        }
    }
